...
## Grupo A
class_brazil.update(position: 1, games: 3, wins: 2, draws: 1, loses: 0, points: 7, goals: 7, saldo: 6)
class_croatia.update(position: 3, games: 3, wins: 1, draws: 0, loses: 2, points: 3, goals: 6, saldo: 0)
class_mexico.update(position: 2, games: 3, wins: 2, draws: 1, loses: 0, points: 7, goals: 4, saldo: 3)
class_cameroon.update(position: 4, games: 3, wins: 0, draws: 0, loses: 3, points: 0, goals: 1, saldo: -8)

## Grupo B
class_spain.update(position: 3, games: 3, wins: 1, draws: 0, loses: 2, points: 3, goals: 4, saldo: -3)
class_netherlands.update(position: 1, games: 3, wins: 3, draws: 0, loses: 0, points: 9, goals: 10, saldo: 7)
class_chile.update(position: 2, games: 3, wins: 2, draws: 0, loses: 1, points: 6, goals: 5, saldo: 2)
class_australia.update(position: 4, games: 3, wins: 0, draws: 0, loses: 3, points: 0, goals: 3, saldo: -6)

## Grupo C
class_colombia.update(position: 1, games: 3, wins: 3, draws: 0, loses: 0, points: 9, goals: 9, saldo: 7)
class_greece.update(position: 2, games: 3, wins: 1, draws: 1, loses: 1, points: 4, goals: 2, saldo: -2)
class_cote.update(position: 3, games: 3, wins: 1, draws: 0, loses: 2, points: 3, goals: 4, saldo: -1)
class_japan.update(position: 4, games: 3, wins: 0, draws: 1, loses: 2, points: 1, goals: 2, saldo: -4)
...
class_bosnia.update(position: 3, games: 3, wins: 1, draws: 0, loses: 2, points: 3, goals: 4, saldo: 0)
class_iran.update(position: 4, games: 3, wins: 0, draws: 1, loses: 2, points: 1, goals: 1, saldo: -3)
...
## Grupo H
class_belgium.update(position: 1, games: 3, wins: 3, draws: 0, loses: 0, points: 9, goals: 4, saldo: 3)
class_algeria.update(position: 2, games: 3, wins: 1, draws: 1, loses: 1, points: 4, goals: 6, saldo: 1)
class_russia.update(position: 3, games: 3, wins: 0, draws: 2, loses: 1, points: 2, goals: 2, saldo: -1)
class_korea.update(position: 4, games: 3, wins: 0, draws: 1, loses: 2, points: 1, goals: 3, saldo: -3)
...
game33 = Game.create(game_number: 33, team1: cameroon, team2: brazil, venue:brasilia, date: '23/06', time:'17:00', group: groupA)
game34 = Game.create(game_number: 34, team1: croatia, team2: mexico, venue:recife, date: '23/06', time:'17:00', group: groupA)
...
game33.update(goals1: 1, goals2: 4)
game34.update(goals1: 1, goals2: 3)
...
game35 = Game.create(game_number: 35, team1: australia, team2: spain, venue:curitiba, date: '23/06', time:'13:00', group: groupB)
game36 = Game.create(game_number: 36, team1: netherlands, team2: chile, venue:sp, date: '23/06', time:'13:00', group: groupB)
...
game35.update(goals1: 0, goals2: 3)
game36.update(goals1: 2, goals2: 0)
...
game22 = Game.create(game_number: 22, 
			...
			time: '19:00', 
			group: groupC)
game37 = Game.create(game_number: 37, 
			team1: japan, 
			team2: colombia, 
			venue: cuiaba, 
			date: '24/06', 
...
game37.update(goals1: 1, goals2: 4)
game38.update(goals1: 2, goals2: 1)
...
game10 = Game.create(game_number: 10, 
			...
			time:'16:00', 
			group: groupE)
game25 = Game.create(game_number: 25, 
			team1: switzerland, 
			team2: france, 
			venue: salvador, 
			date: '20/06', 
			time:'16:00', 
			group: groupE)
game26 = Game.create(game_number: 26, 
			team1: honduras, 
			team2: ecuador, 
			venue: curitiba, 
			date: '20/06', 
...
game12 = Game.create(game_number: 12, 
			...
			time: '16:00', 
			group: groupF)
game27 = Game.create(game_number: 27, 
			team1: argentina, 
			team2: iran, 
			venue: bh, 
			date: '21/06', 
...
game28 = Game.create(game_number: 28, 
			...
			time: '18:00', 
			group: groupF)
game43 = Game.create(game_number: 43, 
			team1: nigeria, 
			team2: argentina, 
			venue: poa, 
			date: '25/06', 
			time: '13:00', 
			group: groupF)
game44 = Game.create(game_number: 44, 
			team1: bosnia, 
			team2: iran, 
			venue: salvador, 
			date: '25/06', 
...
game43.update(goals1: 2, goals2: 3)
game44.update(goals1: 3, goals2: 1)
...
game14 = Game.create(game_number: 14, 
			...
			time: '19:00', 
			group: groupG)
game29 = Game.create(game_number: 29, 
			team1: germany, 
			team2: ghana, 
			venue: fortaleza, 
			date: '21/06', 
			time: '16:00', 
			group: groupG)
game30 = Game.create(game_number: 30, 
			team1: usa, 
			team2: portugal, 
			venue: manaus, 
			date: '22/06', 
...
game16 = Game.create(game_number: 16, 
			...
			time: '18:00', 
			group: groupH)
game31 = Game.create(game_number: 31, 
			team1: belgium, 
			team2: russia, 
			venue: rio, 
			date: '22/06', 
...
game47.update(goals1: 0, goals2: 1)
game48.update(goals1: 1, goals2: 1)
